    ...
    return (
        <div className="flex flex-col items-center justify-center w-full" >
            <Card className="flex flex-col w-full">
                ...
                <HoveredLink href="https://drive.google.com/file/d/17LeUhBIbYmkpuIid11LQlsXAuNN976EO/preview"><span className="text-orange-500">Student VISA Doc Photos</span></HoveredLink>
                </CardFooter>
            </Card>
        </div>
    )
