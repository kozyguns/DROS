    ...
    return (
        <div className="flex flex-col items-center justify-center w-full" >
            <Card className="flex flex-col w-full">
                ...
                <HoveredLink href="https://drive.google.com/file/d/1LdSFNRLvUKI3KDneteIHq4zH2Ebw_noC/preview"><span className="text-orange-500">Work VISA Photo</span></HoveredLink>
                </CardFooter>
            </Card>
        </div>
    )
