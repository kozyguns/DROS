  ...
  const router = useRouter();
    ...
    return (
        ...
        <Card className="flex flex-col w-full">
            ...
            <CardDescription>
                <p>Customer Must Have Purchased A Firearm Within The Last 5 Years At Current Physical Address</p><br/>
                <p>Otherwise, They Must Update Their Address With <span className="text-amber-500">CFARS</span> (Link Below)</p>
                </CardDescription>
            </CardHeader>
            <CardContent>
          ...
          <div className="flex flex-col w-full">
            <h2>Customer Must Have The Following:</h2>
                    <ul className="list-disc pl-4">
                      ...
                      <p>Write Down DOD ID#, Rank & Branch On <span className="text-orange-500">Federal Worksheet (Link Below)</span> </p>
            ...
            <a href="https://drive.google.com/file/d/1ruAqN1-iRgUtTeSfiVmYZHOiosLzFjmE/view"><span className="text-orange-500">Federal Doc Worksheet</span></a>
